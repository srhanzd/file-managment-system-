        ...
        <div class="container">
            <div class="card">
                <div class="cardHeader col-md-12 col">
                    ...
                    <a href="{{ route('user.create') }}" class="btn btn-primary" id="createuser">Create  User</a>
                </div>
                <div class="cardBody">
                        ...
                        @if($users!=null)
                            @foreach ($users as $key=>$user )
                                <tr id="uid{{$user->id}}">
                                    ...
                                    <td>   {{ $user->email }}</td>
                                    <td>   <a href="{{route('user.groups', $user->id)}}">Groups</a></td>
                                    <td>   <a href="{{route('user.history', $user->id)}}">Events</a></td>
                                    <td>


                                        <a href="{{route('user.edit', $user->id)}}" class="btn btn-primary" id="edituser">Edit</a>
