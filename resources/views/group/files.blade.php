...
<div class="signup-form">
    <form action="{{ route('file.modify') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="hidden" class="form-control" name="group"  value="{{$group->id}}">
        </div>
        <div class="form-group">
    ...
    <div class="card" class=" col-md-auto col">
        <div class="cardHeader col-md-auto col">
            <strong style="color:#212121;">
                Files For {{$group->name}} Group
            </strong>
{{--            <a href="#" class="btn btn-danger" id="deleteAllSelected">Delete  Selected from this group</a>--}}
{{--            <a href="#" class="btn btn-primary" id="downloadAllSelected">Download  Selected</a>--}}
            ...
            <a href="{{route('user.group.files.add', $group->id)}}" class="btn btn-link" >ADD  YOUR FILES</a>
...
{{--                            <td>   <a href="{{route('file.history', $items->id)}}">Events</a></td>--}}
                            ...
                            <td>
                                <form method="POST" action="{{route('file.groupdelete',$items->id)}}">
                                    @csrf
...
<script>
    $(function (e){
        ...
        {{--    });--}}
        {{--    $.ajax({--}}
        {{--        url:"{{route('file.deletegroupselected')}}",--}}
        {{--        type:"DELETE",--}}
        {{--        data:{--}}
